        ...
        <c:when test="${not empty funcionario}">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="${linkTo[FuncionarioController].editForm(funcionario.id)}" class="form-horizontal" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3<c:if test="${not empty errors.from('funcionario.checkPasswd')}"> has-error</c:if>">
                                ...
                                <input type="password" name="funcionario.checkPasswd" value="${not empty errors ? funcionario.checkPasswd : ""}" class="form-control input-sm" id="checkPassword" maxlength="30">
